            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">附议记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="proposalName" name="proposalName" class="form-control"
                                                   v-model="ruleForm.proposalName" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>提案简略图</label>
                                        <img id="proposalPhotoImg" width="100" height="100">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>支出/收入</label>
                                        <input id="zirushouhcuValue" name="zirushouhcuValue" class="form-control"
                                               v-model="ruleForm.zirushouhcuValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="proposalMoeny" name="proposalMoeny" class="form-control"
                                                   v-model="ruleForm.proposalMoeny" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="proposalValue" name="proposalValue" class="form-control"
                                               v-model="ruleForm.proposalValue" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="proposalNumber" name="proposalNumber" class="form-control"
                                                   v-model="ruleForm.proposalNumber" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="proposalId" name="proposalId" v-model="ruleForm.proposalId" readonly type="hidden">
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.proposalContent != null && ruleForm.proposalContent != 'null' && ruleForm.proposalContent != '') {
            var proposalContentUeditor = UE.getEditor('proposalContentEditor');
                proposalContentUeditor.ready(function () {
                    ...
                    proposalContentUeditor.setDisabled('fullscreen');
            });
        }
    }
